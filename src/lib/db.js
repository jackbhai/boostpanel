...
export const gatewayOrders = () => secure('gateway.orders', {})
export const gatewayOrderDetail = (txn_id) => secure('gateway.order_detail', { txn_id })
export const gatewayMine = () => secure('gateway.mine', {})
export const gatewayReconcile = () => secure('gateway.reconcile', {})
